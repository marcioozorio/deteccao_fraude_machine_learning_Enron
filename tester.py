...
def test_classifier(clf, dataset, feature_list, isprint, folds = 1000):
    ...
    try:
        ...
        # To return metrics 
        result = {"accuracy": accuracy, "precision": precision, "recall": recall,"f1": f1, "f2": f2}
...
def main(print=True):
    ...
    ### Run testing script
    return test_classifier(clf, dataset, feature_list, print)
